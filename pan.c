...
int
addproc(int n, int par0, int par1, int par2)
{	int j, h = now._nr_pr;
#ifndef NOCOMP
	int k;
#endif
	...
	case 2:	/* :init: */
		...
		/* params: */
		/* locals: */
		((P2 *)pptr(h))->_3_ret_main = addqueue(1, 1);
#ifdef VAR_RANGES
#endif
#ifdef HAS_CODE
		locinit2(h);
	...
	case 1:	/* main */
		...
		reached1[1]=1;
		/* params: */
		((P1 *)pptr(h))->in_main = par0;
		/* locals: */
		((P1 *)pptr(h))->_2_temp0 = 0;
		((P1 *)pptr(h))->_2_ret_input = addqueue(2, 1);
#ifdef VAR_RANGES
		logval("main:temp0", ((P1 *)pptr(h))->_2_temp0);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* input */
		...
		reached0[8]=1;
		/* params: */
		((P0 *)pptr(h))->in_input = par0;
		((P0 *)pptr(h))->min = par1;
		((P0 *)pptr(h))->max = par2;
		/* locals: */
		((P0 *)pptr(h))->_1_1_value = ((P0 *)this)->min;
#ifdef VAR_RANGES
		logval("input:min", ((P0 *)pptr(h))->min);
		logval("input:max", ((P0 *)pptr(h))->max);
		logval("input:value", ((P0 *)pptr(h))->_1_1_value);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
intersect:
	...
	{	tmp->ctx_low = trpt->sched_limit;
		tmp->ctx_pid[(now._last)/8] = 1 << ((now._last)); /* new */
	#ifdef CHECK
		#if NCORE>1
		printf("cpu%d: ", core_id);
		#endif
	...
	&&   (tmp->ctx_pid[(now._last)/8] & ( 1 << ((now._last)) )) == 0 ))
	{	tmp->ctx_pid[(now._last)/8] |= 1 << ((now._last)); /* add */
	#ifdef CHECK
		#if NCORE>1
		printf("cpu%d: ", core_id);
		#endif
...
Append:
	...
	tmp->ctx_low = trpt->sched_limit;
	#ifdef CONSERVATIVE
	tmp->ctx_pid[(now._last)/8] = 1 << ((now._last)); /* new limit */
	#endif
#endif
#if !defined(SAFETY) || defined(REACH)
	tmp->D = depth;
...
iniglobals(void)
{
		...
		now.main_c2 = 0;
		now.reset = 0;
		main_condition_11_copy = 0;
		main_condition_21_copy = 0;
		main_condition_31_copy = 0;
		main_condition_41_copy = 0;
		main_condition_42_copy = 0;
		main_condition_43_copy = 0;
		main_condition_51_copy = 0;
		main_condition_61_copy = 0;
		main_condition_62_copy = 0;
		main_condition_71_copy = 0;
		main_condition_72_copy = 0;
		now.main_condition_73_copy = 0;
		now.main_a = 0;
		now.main_c = 0;
		now.main_b = 0;
#ifdef VAR_RANGES
		logval("main_c1", now.main_c1);
		logval("main_isATriangle", now.main_isATriangle);
		logval("main_c3", now.main_c3);
		logval("main_c2", now.main_c2);
		logval("reset", now.reset);
		logval("main_condition_73_copy", now.main_condition_73_copy);
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->in_input) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->in_input) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->in_input) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->in_input) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->in_main) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->in_main) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->in_main) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->in_main) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->_2_ret_input) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->_2_ret_input) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->_2_ret_input) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->_2_ret_input) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->_3_ret_main) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->_3_ret_main) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->_3_ret_main) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->_3_ret_main) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	bit    main_c1:	%d\n", now.main_c1);
	printf("	bit    main_isATriangle:	%d\n", now.main_isATriangle);
	printf("	bit    main_c3:	%d\n", now.main_c3);
	printf("	bit    main_c2:	%d\n", now.main_c2);
	printf("	int    main_a:	%d\n", now.main_a);
	printf("	int    main_c:	%d\n", now.main_c);
	printf("	int    main_b:	%d\n", now.main_b);
	printf("	bit    reset:	%d\n", now.reset);
	printf("	bit    main_condition_73_copy:	%d\n", now.main_condition_73_copy);
}
void
...
{	/* int i; */
	...
	printf("	chan ret_main (=%d):	len %d:\t", ((P2 *)pptr(pid))->_3_ret_main, q_len(((P2 *)pptr(pid))->_3_ret_main));
	c_chandump(((P2 *)pptr(pid))->_3_ret_main);
		break;
	case 1:
		printf("local vars proc %d (main):\n", pid);
	printf("	chan in_main (=%d):	len %d:\t", ((P1 *)pptr(pid))->in_main, q_len(((P1 *)pptr(pid))->in_main));
	c_chandump(((P1 *)pptr(pid))->in_main);
	printf("	int    temp0:	%d\n", ((P1 *)pptr(pid))->_2_temp0);
	printf("	chan ret_input (=%d):	len %d:\t", ((P1 *)pptr(pid))->_2_ret_input, q_len(((P1 *)pptr(pid))->_2_ret_input));
	c_chandump(((P1 *)pptr(pid))->_2_ret_input);
		break;
	case 0:
		printf("local vars proc %d (input):\n", pid);
	printf("	chan in_input (=%d):	len %d:\t", ((P0 *)pptr(pid))->in_input, q_len(((P0 *)pptr(pid))->in_input));
	c_chandump(((P0 *)pptr(pid))->in_input);
	printf("	int    min:	%d\n", ((P0 *)pptr(pid))->min);
	printf("	int    max:	%d\n", ((P0 *)pptr(pid))->max);
	printf("	int    value:	%d\n", ((P0 *)pptr(pid))->_1_1_value);
		break;
	}
}
void
