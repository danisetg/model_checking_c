...
{	int j, h = now._nr_pr;
	...
	case 1:	/* main */
		...
		((P1 *)pptr(h))->_2_isLeap = 0;
		((P1 *)pptr(h))->_2_day = 0;
		((P1 *)pptr(h))->_2_tomorrowYear = 0;
		((P1 *)pptr(h))->_2_tomorrowMonth = 0;
		((P1 *)pptr(h))->_2_tomorrowDay = 0;
		((P1 *)pptr(h))->_2_year = 0;
		((P1 *)pptr(h))->_2_month = 0;
#ifdef VAR_RANGES
		logval("main:isLeap", ((P1 *)pptr(h))->_2_isLeap);
		logval("main:temp0", ((P1 *)pptr(h))->_2_temp0);
		logval("main:day", ((P1 *)pptr(h))->_2_day);
		logval("main:tomorrowYear", ((P1 *)pptr(h))->_2_tomorrowYear);
		logval("main:tomorrowMonth", ((P1 *)pptr(h))->_2_tomorrowMonth);
		logval("main:tomorrowDay", ((P1 *)pptr(h))->_2_tomorrowDay);
		logval("main:year", ((P1 *)pptr(h))->_2_year);
		logval("main:month", ((P1 *)pptr(h))->_2_month);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
...
{	/* int i; */
	...
	printf("	bit    isLeap:	%d\n", ((P1 *)pptr(pid))->_2_isLeap);
	printf("	int    day:	%d\n", ((P1 *)pptr(pid))->_2_day);
	printf("	int    tomorrowYear:	%d\n", ((P1 *)pptr(pid))->_2_tomorrowYear);
	printf("	int    tomorrowMonth:	%d\n", ((P1 *)pptr(pid))->_2_tomorrowMonth);
	printf("	int    tomorrowDay:	%d\n", ((P1 *)pptr(pid))->_2_tomorrowDay);
	printf("	int    year:	%d\n", ((P1 *)pptr(pid))->_2_year);
	printf("	int    month:	%d\n", ((P1 *)pptr(pid))->_2_month);
		break;
	case 0:
