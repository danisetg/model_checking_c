...
{	int j, h = now._nr_pr;
	...
	case 1:	/* main */
		...
		((P1 *)pptr(h))->_2_isATriangle = 0;
		((P1 *)pptr(h))->_2_a = 0;
		((P1 *)pptr(h))->_2_c = 0;
		((P1 *)pptr(h))->_2_b = 0;
#ifdef VAR_RANGES
		logval("main:isATriangle", ((P1 *)pptr(h))->_2_isATriangle);
		logval("main:temp0", ((P1 *)pptr(h))->_2_temp0);
		logval("main:a", ((P1 *)pptr(h))->_2_a);
		logval("main:c", ((P1 *)pptr(h))->_2_c);
		logval("main:b", ((P1 *)pptr(h))->_2_b);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
...
{	/* int i; */
	...
	printf("	bit    isATriangle:	%d\n", ((P1 *)pptr(pid))->_2_isATriangle);
	printf("	int    a:	%d\n", ((P1 *)pptr(pid))->_2_a);
	printf("	int    c:	%d\n", ((P1 *)pptr(pid))->_2_c);
	printf("	int    b:	%d\n", ((P1 *)pptr(pid))->_2_b);
		break;
